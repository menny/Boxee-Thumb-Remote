...
public class RemoteUiActivity extends FragmentActivity implements
    ...
    final ActionBarHelperBase mActionBarHelper = ActionBarHelperBase.createInstance(this);
    ...
    void doBindService() {
        ...
        mIsBound = bindService(new Intent(getApplicationContext(), ServerRemoteService.class),
                mConnection, 0);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         * refreshPlayingStateChanged(false); break; case
         * MESSAGE_MEDIA_PLAYING_PROGRESS_CHANGED:
         * refreshPlayingProgressChanged(); break; case
         * MESSAGE_MEDIA_METADATA_CHANGED: refreshMetadataChanged(); break; } }
         * };
         */
        mHandler = new Handler();
        mInAnimation = AnimationUtils
                .loadAnimation(getApplicationContext(), R.anim.boxee_dialog_in);
         ...
         * RemoteUiActivity.this.onKeyUp(keyCode, event); return false; } });
         */
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.buttonSmallSkipFwd:
                if (mBoundService != null)
                    mBoundService.remoteSeekOffset((id == R.id.buttonSmallSkipFwd) ? 30f : -30f);
                break;
            case R.id.back:
                if (mBoundService != null)
    ...
    private void refreshPlayingStateChanged(ServerState serverState, boolean forceChanged) {
        ...
        if (mIsMediaActive)
            mButtonPlayPause.setImageResource(isPlaying ? R.drawable.icon_osd_pause_on
    ...
    public boolean onKeyDown(final int keyCode, final KeyEvent event) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_DOWN:
                ...
                final int volumeOffset = (volumeFactor * RemoteApplication.getConfig()
                        .getVolumeStep());
                if (mBoundService != null)
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (mSwipeStepSize < 1)
            mSwipeStepSize = RemoteApplication.getConfig()
                    .getSwipeStepSize(getApplicationContext());
