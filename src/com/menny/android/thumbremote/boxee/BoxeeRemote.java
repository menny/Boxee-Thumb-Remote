...
//
//import com.menny.android.thumbremote.ErrorHandler;
//import com.menny.android.thumbremote.R;
//import com.menny.android.thumbremote.ServerRemote;
...
// * 
// */
//public class BoxeeRemote implements ServerRemote {
//
//	/**
...
//			return;
//
//		final String getvolume = mRequestPrefix + String.format("getVolume()");
//		// TODO: Move around
...
//						final String setvolume = mRequestPrefix + String.format("setVolume(%d)", new_volume);
...
//		sendHttpCommand(mRequestPrefix + "Pause");
//	}
//
//	/* (non-Javadoc)
...
//	@Override
//	public void stop() {
//		sendHttpCommand(mRequestPrefix + "Stop");
//	}
//
//	/* (non-Javadoc)
...
//		sendHttpCommand(mRequestPrefix + "SeekPercentageRelative(" + pct + ")");
//	}
//
...
//		}
//
//		String request = mRequestPrefix + String.format("SendKey(%d)", keycode);
//
...
//		mPort = server.port();
//		mRequestPrefix = String.format("http://%s:%d/xbmcCmds/xbmcHttp?command=", mHost, mPort);
